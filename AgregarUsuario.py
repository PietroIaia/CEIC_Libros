...
class AgregarUsuario(QWidget):
    ...
    def __init__(self):
        ...
        self.confirmContraseñaLabel = QLabel("Confirmar contraseña")
        ...
        self.confirmContraseñaInput.setStyleSheet('background-color: white')
        ...
        #Layout boton de permiso
        self.permLayout = QFormLayout()
        self.permLayout.addRow(self.permisosLabel, self.permisosInput)
        ...
        self.layout.addWidget(self.confirmContraseñaLabel)
        self.layout.addWidget(self.confirmContraseñaInput)
        ...
        self.layout.addWidget(self.emailInput)
        self.layout.addLayout(self.permLayout)
